...
export const ICON_GROUPS: Array<{ label: string; items: Array<{ name: IconName; label: string }> }> = [
  ...
  { label: "Oci i vida", items: [["cinema","Cinema"],["music","Música"],["game","Videojoc"],["book","Llibre"],["gift","Regal"],["suitcase","Viatges"],["pet","Mascota"],["family","Família"],["baby","Nadó"],["education","Educació"]].map(([name,label]) => ({ name:name as IconName, label })) },
